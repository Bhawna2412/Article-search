---
title: "Neto Webstore Themes"
articleID: 1113
category: "Ways to Sell on Neto > Webstore > Get Started Sell"
knowledgeBase: "Neto By Maropost"
---

# Neto Webstore Themes

> **Note:** Neto partners can design and customise a theme to your needs. [Contact a design partner](https://www.netohq.com/job-request-form/form) for a consultation.
...
Note that the filter criteria do not stack, meaning that the themes shown may not necessarily meet all the selected options.
...
2. Scroll down to the **All Themes** section. When you find one that you like, hover your mouse over the thumbnail image. Click the **Add Theme** button to add the theme to your Neto site.
  ![Image](https://us.v-cdn.net/6038474/uploads/attachments/migrated/chromeuzXw7mg7VF.05T5g00000jDXuCEAW.png)
3. You will be presented with a popup asking if you wish to edit the theme. Click **No** to refresh the page.

Once the theme has been added to My Themes on your Neto site, you must Publish it to make it the Live theme for your website. To do this scroll to the My Themes section and hover over the theme with your mouse. Where the Add Theme button was, there will now be a **Publish** button. Click this and the theme will be set s your current Live theme.

> **Note:** You can preview what a theme will look like by entering your website address, followed by **/?nview=** and the name of your theme e.g. **mywebstore.mymaropost.com/?nview=skeletal** or **mywebstore.com.au/?nview=skeletal**.
...
![Image](https://us.v-cdn.net/6038474/uploads/attachments/migrated/chromeFrSPqUwGCt.05T5g00000jDmR5EAK.png)
...
![Image](https://us.v-cdn.net/6038474/uploads/attachments/migrated/MaropostCommerceCloudWebstoreThemes3.05T5g00000hz4HsEAI.png)
...
> **Note:** The theme assets for the default theme, skeletal, is located in `/httpdocs/assets/themes/skeletal`.
...
> **Note:** Located in `/httpdocs/assets/themes/your-theme-name/templates/cms`.
...
Our parser will go through template files on page load and parse these tags for you. There are many tags, and they can be extremely powerful `[%IF%]` tags and expressions for example). We wont go through them in this walkthrough, but you can find a list of all [B@SE tags here](http://developers.neto.com.au/documentation/web-designers/b-se-tag-library/).

## Create a Neto Theme

Make sure you [request SFTP access](http://forms.neto.com.au/design/requestftp.html) from us so you can make changes.
...
In order to change your view to see your new theme, you can visit the site url:
...
To clear the nview and to go back to default, simple type in the following url:
...
**Please Note**: Neto partners can be granted access by completing [this form](https://www.netohq.com/support/s/request-partner-access).
...
Control panel access is required to clear the web accelerator cache during implementation, as well as scope out if and how the requested modifications will work in the context of your website.
