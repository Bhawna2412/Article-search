---
title: "Follow-Up Actions Upon Form Submission"
articleID: 1736
...
# Follow-Up Actions Upon Form Submission

You can configure automated follow-up actions using Marketing Cloud's Acquisition Builder to create seamless lead capture and engagement workflows. Understanding these action types helps optimize your website conversion process by providing multiple options for responding to visitor interactions, from form submissions to personalized content delivery.

Acquisition Builder actions enable more sophisticated lead nurturing by allowing you to create custom workflows that respond to visitor behavior with relevant actions. When properly implemented, these automated sequences can substantially improve conversion rates by delivering timely, relevant experiences that guide visitors through your marketing funnel.
...
You can also add more parameters and values. For example, suppose you have set the lightbox to only appear from a specific referred URL. You can then pass the referred URL as a parameter value to your system.

### Subscribe Contact

The Subscribe Contact action, together with the Display Popup action, is one compelling reason why Maropost for Marketing's Acquisition Builder is a better solution than any 3rd-party. The lightbox form data goes directly into your Maropost for Marketing account. You don't have to worry about integrating Maropost with your 3rd-party provider. It's all built into the platform.
...
This action will redirect the site visitor's browser to the URL that you specify. This is typically used to redirect the site visitor to a landing page on your site after submitting the lightbox form. This action includes the option to include the lightbox form fields as query string parameters appended to the redirected URL.
